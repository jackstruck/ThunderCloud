...
SELECT format(
    'GRANT SELECT, INSERT, UPDATE, DELETE ON identity, subject, source_asset, processing_job, face_track, processing_rollout, processing_work_item, media_run, submission_face_group, run_candidate, run_operation, subject_representative_face, run_cleanup_object, gallery_cleanup_object TO %I',
    :'app_user'
) \gexec
